...
function Inventory() {
  ...
  const handleSearchTerm = (e) => {
    ...
    if (e.target.value) {
      ...
      fetchProductsData(); // Fetch all products if search term is cleared
    }
  };
              ...
              {products.map((element) => {
                return (
                  <tr key={element._id}>
                    ...
                    <td className="whitespace-nowrap px-4 py-2 text-gray-900">
                      {element.availability ? "In Stock" : "Out of Stock"}
                    </td>
                    <td className="whitespace-nowrap px-4 py-2 text-gray-900">
                      <div className="flex gap-2">
                        <button
                          className="bg-yellow-500 hover:bg-yellow-700 text-white font-bold text-xs p-1 rounded"
                          onClick={() => updateProductModalSetting(element)}
                        >
                          Edit
                        </button>
                        <button
                          className="bg-red-500 hover:bg-red-700 text-white font-bold text-xs p-1 rounded"
